<!--
  Booking Feature — AppointmentForm component

  Canonical implementation moved from `app/components/ApointmentForm.vue` as
  part of Step 4 (migrate-booking-logic).  The legacy file at that path is
  now a re-export shim and should be removed once the page imports this
  component directly.
-->
